...
function ErrorDisplay({ error, onRetry }) {
  return (
    ...
    >
      <div style={{ fontSize: 80, marginBottom: 20,fontWeight: 'bold' }}>505!😓</div>
      <h2 style={{ fontSize: 36, marginBottom: 15 }}>
        Oops! Bentar Lagi Dibenerin Sayang
      </h2>
      <p style={{ fontSize: 18, opacity: 0.8, marginBottom: 30 }}>
  Bentar Admin Lagi Memperbaiki Patch Dibawah  .............
</p>
{error && (
  <p style={{ fontSize: 16, color: 'blue', marginTop: 0.000001 }}>
    {error}
  </p>
)}
