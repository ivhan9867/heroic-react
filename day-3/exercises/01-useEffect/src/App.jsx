...
const mockHeroes = [
  ...
  { id: 3, name: "Wonder Woman", team: "Justice League", power: "Super strength" },
...
function TitleUpdater() {
  ...
  return (
    <div className="card">
      ...
      <p style={{ opacity: 0.7, fontSize: 14 }}>Check the browser tab title!</p>
...
function Timer() {
  ...
  return (
    <div className="card" style={{ textAlign: "center" }}>
      ...
      <p style={{ fontSize: 48, fontWeight: "bold", margin: "20px 0" }}>{seconds}s</p>
...
function HeroLoader() {
  ...
  if (error)
    return (
      <div className="card" style={{ backgroundColor: "rgba(255,100,100,0.2)", textAlign: "center" }}>
        <p style={{ color: "#ff6b6b", fontSize: 18 }}>❌ Error: {error}</p>
      </div>
    );

  return (
    <div className="card">
      <h2 style={{ marginTop: 0 }}>🦸 Loaded Heroes ({heroes.length})</h2>
      ...
      <div style={{ display: "grid", gap: 10 }}>
        {heroes.map((hero) => (
          ...
          >
            <h3 style={{ margin: "0 0 5px", fontSize: 18 }}>{hero.name}</h3>
